    ...
    <div class="w3-col l12 s12">
      <div class="w3-container">
        <div class="w3-display-container">
          ...
          <img src="<?php echo $rs[pic_src]?>" height="85%" width="85%" align="center"/>
          <?php
          //if()
            //echo '<span class="w3-tag w3-display-topleft">New</span>'?>
          <div class="w3-display-middle w3-display-hover">
            <div align="center"><button class="w3-button w3-black" onclick="document.getElementById('<?php echo $rs[audio_id]?>').play(); return false;">Play</button></div>
          </div>
        </div>

...
<link rel="icon" href="../picture/ear.png">
<style>
...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    <a href="firstpage.php" class="w3-bar-item w3-button">首頁</a>
    <a href="training.php" class="w3-button w3-block w3-white w3-left-align">訓練模式<i class="fa fa-caret-down"></i>
    </a>
